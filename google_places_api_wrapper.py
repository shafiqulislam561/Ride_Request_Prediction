...
YOUR_API_KEY = 'AIzaSyCcFEiGEhlQpLEX_ard7WPOyapIIj1Rq14'
...
for place in query_result.places:
    ...
    #for photo in place.photos:
        ...
        #photo.get(maxheight=100000, maxwidth=100000)
        # MIME-type, e.g. 'image/jpeg'
        #photo.mimetype
        # Image URL
        #photo.html_attribution.url
        # Original filename (optional)
        #photo.html_attribution.filename
        # Raw image data
        #photo.html_attribution.data
